...
public class Shed {
    ...
    /**
     * The constructor for Shed calls calculation methods from the class CalcShedMaterials.
     * I use these to determine the values for Shed - The global variabels are set upon creating a instance of Shed.
