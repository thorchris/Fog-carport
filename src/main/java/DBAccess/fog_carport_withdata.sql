CREATE DATABASE  IF NOT EXISTS `fogcarport` /*!40100 DEFAULT CHARACTER SET utf8mb4*/ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fogcarport`;
...
INSERT INTO `customer_order` VALUES (48,61,2,240,240,1,1,1,1,1,2,25,10000),(49,62,2,540,780,0,0,2,2,2,2,10,15000);
...
INSERT INTO `orders` VALUES (61,2,4,24,4,10,4,10,4,1,1),(62,2,12,36,4,100,4,10,4,1,1);
