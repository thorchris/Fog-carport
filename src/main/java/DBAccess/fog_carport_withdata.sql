...
INSERT INTO `customer_order` VALUES (1,1,2,240,240,1,1,1,1,1,2,25,10000),(2,2,2,540,780,0,0,2,2,2,2,10,15000);
...
INSERT INTO `orders` VALUES (1,2,4,24,4,10,4,10,4,1,1),(2,2,12,36,4,100,4,10,4,1,1);
